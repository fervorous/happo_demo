...
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }(); // This is file is only for the standalone "old happo" runner.
/* global happo */
...
var requireTests = __webpack_require__(27);

var tests = [];
requireTests.keys().forEach(function (path) {
  var _path$replace$replace = path.replace('./', '').replace(/\.happo\.js$/, '').split('/'),
      _path$replace$replace2 = _slicedToArray(_path$replace$replace, 2),
      suite = _path$replace$replace2[0],
      name = _path$replace$replace2[1];

  Object.keys(requireTests(path)).forEach(function (key) {
    tests.push({
      suite: suite,
      name: key,
...
tests.forEach(function (test) {
  happo.define(test.suite + '-' + test.name, function () {
    var div = document.createElement('div');
    div.style.padding = '8px';
    div.style.display = 'inline-block';
    document.body.appendChild(div);
    var TestCase = test.case;
    (0, _reactDom.render)(_react2.default.createElement(TestCase, null), div);
...
exports.ButtonB = exports.ButtonA = undefined;
...
var ButtonA = exports.ButtonA = function ButtonA() {
...
var ButtonB = exports.ButtonB = function ButtonB() {
  return _react2.default.createElement(
    _Button2.default,
    null,
    'World'
